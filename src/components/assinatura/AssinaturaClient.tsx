...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Vendas geram 8% de cashback", highlight: true },
      { text: "Compras geram 4% de cashback", highlight: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Vendas geram 8% de cashback" },
      { text: "Compras geram 4% de cashback" },
