...
export function HeaderAuth({ user }: HeaderAuthProps) {
    ...
    return (
      <>
        <div className="flex items-center gap-3">
          ...
          <button className="rounded-full bg-teal px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-teal/90">
            Quero vender
          </button>
        </div>
  ...
  return (
    <div className="relative flex items-center gap-3">
      <button className="hidden sm:block rounded-full bg-teal px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-teal/90">
        Quero vender
      </button>
      ...
      {isMenuOpen && (
        <div className="absolute right-0 top-12 z-50 w-48 rounded-xl border border-gray-100 bg-white py-2 shadow-lg">
          ...
          <button className="flex w-full items-center gap-2 px-4 py-2 text-sm text-airforce hover:bg-gray-50">
