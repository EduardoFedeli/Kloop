...
import { MetasClient as MissoesClient } from '@/components/vendas/MissoesClient'
    ...
    <div className="min-h-screen bg-[var(--background)]">
      <div className="max-w-lg mx-auto px-4 pb-20">
        ...
        <div className="flex items-center gap-3 py-5">
          ...
          <div>
            <h1 className="text-[19px] font-black text-[var(--foreground)] leading-tight">missões</h1>
        ...
        <div className="rounded-2xl bg-amber-50 dark:bg-amber-500/8 border border-amber-200/60 dark:border-amber-500/15 p-5 mb-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[12px] text-gray-500 dark:text-sage leading-relaxed mt-0.5">
              complete missões e ganhe cashback. o saldo cai direto na sua carteira.
            </p>
          </div>
        </div>

        {/* Lista interativa com abas ativas / concluídas */}
        <MissoesClient achievements={achievements} />
