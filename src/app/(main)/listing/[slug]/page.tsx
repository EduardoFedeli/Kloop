        ...
        <div className="px-5 mt-5 space-y-8">
          ...
          {listing.brand && (
            <section className="flex items-center justify-between">
              <div><p className="text-[13px] text-gray-500 dark:text-sage mb-1">marca</p><p className="font-bold text-[14px] text-[var(--foreground)]">{listing.brand}</p></div>
          ...
          <section className="bg-gray-50 dark:bg-[var(--color-forest)] rounded-2xl p-5 space-y-6">
            <div className="flex gap-4"><Lock size={20} className="text-[var(--foreground)] flex-shrink-0 mt-0.5" /><div><p className="text-[14px] font-bold text-[var(--foreground)] mb-1">não caia em golpes</p><p className="text-[13px] text-gray-600 dark:text-sage leading-relaxed">nunca transfira dinheiro ou se comunique fora do site ou aplicativo do kloop.</p><button className="text-[13px] font-bold text-[var(--color-pine)] dark:text-white mt-2">mais dicas de segurança</button></div></div>
            <hr className="border-gray-200 dark:border-white/5" />
            <div className="flex gap-4"><Package size={20} className="text-[var(--foreground)] flex-shrink-0 mt-0.5" /><div className="flex-1"><p className="text-[14px] font-bold text-[var(--foreground)] mb-1">se não gostar, você pode devolver</p><p className="text-[13px] text-gray-600 dark:text-sage leading-relaxed">a partir da data de recebimento do produto, você tem 7 dias corridos para solicitar a devolução.</p></div></div>
            <hr className="border-gray-200 dark:border-white/5" />
            <div className="flex gap-4"><AlertTriangle size={20} className="text-[var(--foreground)] flex-shrink-0 mt-0.5" /><div className="flex-1"><p className="text-[14px] font-bold text-[var(--foreground)] mb-1">denúncia</p><p className="text-[13px] text-gray-600 dark:text-sage leading-relaxed">encontrou algo de errado com esse anúncio? denuncie-o aqui.</p></div></div>
          </section>
        </div>
      </div>
